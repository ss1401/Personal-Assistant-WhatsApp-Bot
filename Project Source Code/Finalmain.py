...
def text_now(send_message):
    ...
    user_name_list = ['aadi', 'Janhavi Mhatre', 'Rakshita Danee', 'Sahana Shetty', 'Simran Huddedar Ves', 'Yash Rajeee']
...
meet=cursor.execute("SELECT link FROM Lecture_Slot WHERE Slot_ID=1")
meet_list = meet.fetchall()
...
class Assignment(QtWidgets.QMainWindow):
    ...
    def Addfunction(self):
        ...
        conn.commit()
        assnotif="Assignment Code: " +acode+" Assignment Name: "+aname+" Due Date: "+duedate+" Subject Name: "+ subjectname
        text_now(assnotif)
        self.show_popup()
...
class Timetable(QtWidgets.QMainWindow):
    ...
    def Updatefunction(self):
        ...
        conn.commit()
        self.ShowTT()
        sendlink= "Link for "+subject+" is: "+link
        text_now(sendlink)

        #time.ctime()
        #Fri Mar 22 19:43:11 2019
        self.show_popup()
